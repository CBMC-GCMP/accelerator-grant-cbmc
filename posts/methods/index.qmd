...
author: "Fabio Favoretto, Eduardo León Solórzano, Ricardo Cavieses Nuñez"
date: "2022-10-03"
categories: [methods]
image: "thumbnail.png"
code-fold: true
...
As a statistical protocol for our GAM analysis, we followed commonly applied methods to check the validity of the model fit as well as autocorrelation problems ( @zuur2016; @wood2017 ). We used the mgcv R package ( @wood2011 ) for all the GAM analyses in this project.
...
The code to reproduce the ML model is available [here](https://github.com/CBMC-GCMP/accelerator-grant-cbmc/blob/master/code/modelo-PGeneral.ipynb), which was run on a SageMaker studio environment.
