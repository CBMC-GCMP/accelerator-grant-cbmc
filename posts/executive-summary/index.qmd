...
All data needed to replicate the analysis showcased here can be downloaded from [here](https://github.com/CBMC-GCMP/accelerator-grant-cbmc/tree/master/data). Full datasets of permits, landings, and VMS data is available through our R package [dafishr](https://github.com/CBMC-GCMP/dafishr).
